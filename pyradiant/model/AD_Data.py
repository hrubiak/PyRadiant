...
"""Implements the a data class for loading data from the EPICS Area Detector.

Usage:
mydata = AD_Data(record_name)

most important properties:

x_calibration - wavelength information of x-axis. This should be supplied by the user since this is not a part of the AD record


the data will be automatically loaded and all important parameters and the data 
can be requested from the object.

RH: Updated July 3, 2024
"""
...
class AD_data(QObject):
    def __init__(self, record_name, x_calibration, debug=False):
